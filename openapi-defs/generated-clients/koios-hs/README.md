## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Koios API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Koios API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Koios                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | koios                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | KoiosConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | KoiosRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Koios.Client    | use the "dispatch" functions to send requests       |
| Koios.Core      | core functions, config and request types            |
| Koios.API       | construct api requests                              |
| Koios.Model     | describes api models                                |
| Koios.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Koios.ModelLens | lenses for model fields                             |
| Koios.Logging   | logging functions and utils                         |
