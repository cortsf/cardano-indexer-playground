...
module Koios.API.Account where
...
-- 
accountAddressesPost
  :: (Consumes AccountAddressesPost MimeJSON)
  => KoiosRequest AccountAddressesPost MimeJSON [AccountAddressesInner] MimeJSON
accountAddressesPost =
  _mkRequest "POST" ["/account_addresses"]

data AccountAddressesPost 
instance HasBodyParam AccountAddressesPost AccountInfoPostRequest 

-- | @application/json@
instance Consumes AccountAddressesPost MimeJSON

-- | @application/json@
instance Produces AccountAddressesPost MimeJSON
...
-- 
accountAssetsPost
  :: (Consumes AccountAssetsPost MimeJSON)
  => KoiosRequest AccountAssetsPost MimeJSON [AccountAssetsInner] MimeJSON
accountAssetsPost =
  _mkRequest "POST" ["/account_assets"]

data AccountAssetsPost 
instance HasBodyParam AccountAssetsPost AccountInfoPostRequest 

-- | @application/json@
instance Consumes AccountAssetsPost MimeJSON

-- | @application/json@
instance Produces AccountAssetsPost MimeJSON
...
-- 
accountHistoryPost
  :: (Consumes AccountHistoryPost MimeJSON)
  => KoiosRequest AccountHistoryPost MimeJSON [AccountHistoryInner] MimeJSON
accountHistoryPost =
  _mkRequest "POST" ["/account_history"]

data AccountHistoryPost 
instance HasBodyParam AccountHistoryPost AccountInfoPostRequest 

-- | @application/json@
instance Consumes AccountHistoryPost MimeJSON

-- | @application/json@
instance Produces AccountHistoryPost MimeJSON
...
-- 
accountInfoPost
  :: (Consumes AccountInfoPost MimeJSON)
  => KoiosRequest AccountInfoPost MimeJSON [AccountInfoInner] MimeJSON
accountInfoPost =
  _mkRequest "POST" ["/account_info"]

data AccountInfoPost 
instance HasBodyParam AccountInfoPost AccountInfoPostRequest 

-- | @application/json@
instance Consumes AccountInfoPost MimeJSON

-- | @application/json@
instance Produces AccountInfoPost MimeJSON
...
-- 
accountListGet
  :: KoiosRequest AccountListGet MimeNoContent [AccountListInner] MimeJSON
accountListGet =
  _mkRequest "GET" ["/account_list"]

data AccountListGet  
-- | @application/json@
instance Produces AccountListGet MimeJSON
...
-- 
accountRewardsPost
  :: (Consumes AccountRewardsPost MimeJSON)
  => KoiosRequest AccountRewardsPost MimeJSON [AccountRewardsInner] MimeJSON
accountRewardsPost =
  _mkRequest "POST" ["/account_rewards"]

data AccountRewardsPost 
instance HasBodyParam AccountRewardsPost AccountInfoPostRequest 

-- | @application/json@
instance Consumes AccountRewardsPost MimeJSON

-- | @application/json@
instance Produces AccountRewardsPost MimeJSON
...
-- 
accountUpdatesPost
  :: (Consumes AccountUpdatesPost MimeJSON)
  => KoiosRequest AccountUpdatesPost MimeJSON [AccountUpdatesInner] MimeJSON
accountUpdatesPost =
  _mkRequest "POST" ["/account_updates"]

data AccountUpdatesPost 
instance HasBodyParam AccountUpdatesPost AccountInfoPostRequest 

-- | @application/json@
instance Consumes AccountUpdatesPost MimeJSON

-- | @application/json@
instance Produces AccountUpdatesPost MimeJSON
