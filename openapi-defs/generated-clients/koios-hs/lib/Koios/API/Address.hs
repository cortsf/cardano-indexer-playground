...
module Koios.API.Address where
...
-- 
addressAssetsPost
  :: (Consumes AddressAssetsPost MimeJSON)
  => KoiosRequest AddressAssetsPost MimeJSON [AddressAssetsInner] MimeJSON
addressAssetsPost =
  _mkRequest "POST" ["/address_assets"]

data AddressAssetsPost 
instance HasBodyParam AddressAssetsPost AddressInfoPostRequest 

-- | @application/json@
instance Consumes AddressAssetsPost MimeJSON

-- | @application/json@
instance Produces AddressAssetsPost MimeJSON
...
-- 
addressInfoPost
  :: (Consumes AddressInfoPost MimeJSON)
  => KoiosRequest AddressInfoPost MimeJSON [AddressInfoInner] MimeJSON
addressInfoPost =
  _mkRequest "POST" ["/address_info"]

data AddressInfoPost 
instance HasBodyParam AddressInfoPost AddressInfoPostRequest 

-- | @application/json@
instance Consumes AddressInfoPost MimeJSON

-- | @application/json@
instance Produces AddressInfoPost MimeJSON
...
-- 
addressTxsPost
  :: (Consumes AddressTxsPost MimeJSON)
  => KoiosRequest AddressTxsPost MimeJSON [AddressTxsInner] MimeJSON
addressTxsPost =
  _mkRequest "POST" ["/address_txs"]

data AddressTxsPost 
instance HasBodyParam AddressTxsPost AddressTxsPostRequest 

-- | @application/json@
instance Consumes AddressTxsPost MimeJSON

-- | @application/json@
instance Produces AddressTxsPost MimeJSON
...
-- 
credentialTxsPost
  :: (Consumes CredentialTxsPost MimeJSON)
  => KoiosRequest CredentialTxsPost MimeJSON [AddressTxsInner] MimeJSON
credentialTxsPost =
  _mkRequest "POST" ["/credential_txs"]

data CredentialTxsPost 
instance HasBodyParam CredentialTxsPost CredentialTxsPostRequest 

-- | @application/json@
instance Consumes CredentialTxsPost MimeJSON

-- | @application/json@
instance Produces CredentialTxsPost MimeJSON
