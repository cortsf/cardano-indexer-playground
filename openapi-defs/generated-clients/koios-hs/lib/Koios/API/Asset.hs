...
-- 
assetAddressListGet
  :: AssetPolicy -- ^ "assetPolicy" -  Asset Policy ID in hexadecimal format (hex)
  -> KoiosRequest AssetAddressListGet MimeNoContent [AssetAddressListInner] MimeJSON
assetAddressListGet (AssetPolicy assetPolicy) =
  _mkRequest "GET" ["/asset_address_list"]
    `addQuery` toQuery ("_asset_policy", Just assetPolicy)

data AssetAddressListGet  

-- | /Optional Param/ "_asset_name" - Asset Name in hexadecimal format (hex)
instance HasOptionalParam AssetAddressListGet AssetName where
  applyOptionalParam req (AssetName xs) =
    req `addQuery` toQuery ("_asset_name", Just xs)
-- | @application/json@
instance Produces AssetAddressListGet MimeJSON
...
assetHistoryGet
  :: AssetPolicy -- ^ "assetPolicy" -  Asset Policy ID in hexadecimal format (hex)
  -> KoiosRequest AssetHistoryGet MimeNoContent [AssetHistoryInner] MimeJSON
assetHistoryGet (AssetPolicy assetPolicy) =
  _mkRequest "GET" ["/asset_history"]
    `addQuery` toQuery ("_asset_policy", Just assetPolicy)

data AssetHistoryGet  

-- | /Optional Param/ "_asset_name" - Asset Name in hexadecimal format (hex)
instance HasOptionalParam AssetHistoryGet AssetName where
  applyOptionalParam req (AssetName xs) =
    req `addQuery` toQuery ("_asset_name", Just xs)
-- | @application/json@
instance Produces AssetHistoryGet MimeJSON
...
assetInfoGet
  :: AssetPolicy -- ^ "assetPolicy" -  Asset Policy ID in hexadecimal format (hex)
  -> KoiosRequest AssetInfoGet MimeNoContent [AssetInfoInner] MimeJSON
assetInfoGet (AssetPolicy assetPolicy) =
  _mkRequest "GET" ["/asset_info"]
    `addQuery` toQuery ("_asset_policy", Just assetPolicy)

data AssetInfoGet  

-- | /Optional Param/ "_asset_name" - Asset Name in hexadecimal format (hex)
instance HasOptionalParam AssetInfoGet AssetName where
  applyOptionalParam req (AssetName xs) =
    req `addQuery` toQuery ("_asset_name", Just xs)
-- | @application/json@
instance Produces AssetInfoGet MimeJSON
...
-- 
assetListGet
  :: KoiosRequest AssetListGet MimeNoContent [AssetListInner] MimeJSON
assetListGet =
  _mkRequest "GET" ["/asset_list"]

data AssetListGet  
-- | @application/json@
instance Produces AssetListGet MimeJSON
...
assetPolicyInfoGet
  :: AssetPolicy -- ^ "assetPolicy" -  Asset Policy ID in hexadecimal format (hex)
  -> KoiosRequest AssetPolicyInfoGet MimeNoContent [AssetPolicyInfoInner] MimeJSON
assetPolicyInfoGet (AssetPolicy assetPolicy) =
  _mkRequest "GET" ["/asset_policy_info"]
    `addQuery` toQuery ("_asset_policy", Just assetPolicy)

data AssetPolicyInfoGet  
-- | @application/json@
instance Produces AssetPolicyInfoGet MimeJSON
...
assetSummaryGet
  :: AssetPolicy -- ^ "assetPolicy" -  Asset Policy ID in hexadecimal format (hex)
  -> KoiosRequest AssetSummaryGet MimeNoContent [AssetSummaryInner] MimeJSON
assetSummaryGet (AssetPolicy assetPolicy) =
  _mkRequest "GET" ["/asset_summary"]
    `addQuery` toQuery ("_asset_policy", Just assetPolicy)

data AssetSummaryGet  

-- | /Optional Param/ "_asset_name" - Asset Name in hexadecimal format (hex)
instance HasOptionalParam AssetSummaryGet AssetName where
  applyOptionalParam req (AssetName xs) =
    req `addQuery` toQuery ("_asset_name", Just xs)
-- | @application/json@
instance Produces AssetSummaryGet MimeJSON
...
assetTxsGet
  :: AssetPolicy -- ^ "assetPolicy" -  Asset Policy ID in hexadecimal format (hex)
  -> KoiosRequest AssetTxsGet MimeNoContent [AssetTxsInner] MimeJSON
assetTxsGet (AssetPolicy assetPolicy) =
  _mkRequest "GET" ["/asset_txs"]
    `addQuery` toQuery ("_asset_policy", Just assetPolicy)

data AssetTxsGet  

-- | /Optional Param/ "_asset_name" - Asset Name in hexadecimal format (hex)
instance HasOptionalParam AssetTxsGet AssetName where
  applyOptionalParam req (AssetName xs) =
    req `addQuery` toQuery ("_asset_name", Just xs)
-- | @application/json@
instance Produces AssetTxsGet MimeJSON
