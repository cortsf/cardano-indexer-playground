...
module Koios.API.Network where
...
-- 
genesisGet
  :: KoiosRequest GenesisGet MimeNoContent [GenesisInner] MimeJSON
genesisGet =
  _mkRequest "GET" ["/genesis"]

data GenesisGet  
-- | @application/json@
instance Produces GenesisGet MimeJSON
...
-- 
tipGet
  :: KoiosRequest TipGet MimeNoContent [TipInner] MimeJSON
tipGet =
  _mkRequest "GET" ["/tip"]

data TipGet  
-- | @application/json@
instance Produces TipGet MimeJSON
...
-- 
totalsGet
  :: KoiosRequest TotalsGet MimeNoContent [TotalsInner] MimeJSON
totalsGet =
  _mkRequest "GET" ["/totals"]

data TotalsGet  

-- | /Optional Param/ "_epoch_no" - Epoch Number to fetch details for
instance HasOptionalParam TotalsGet EpochNo where
  applyOptionalParam req (EpochNo xs) =
    req `addQuery` toQuery ("_epoch_no", Just xs)
-- | @application/json@
instance Produces TotalsGet MimeJSON
