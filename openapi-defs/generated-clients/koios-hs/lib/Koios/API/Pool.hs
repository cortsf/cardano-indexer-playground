...
-- 
poolBlocksGet
  :: PoolBech32 -- ^ "poolBech32" -  Pool ID in bech32 format
  -> KoiosRequest PoolBlocksGet MimeNoContent [PoolBlocksInner] MimeJSON
poolBlocksGet (PoolBech32 poolBech32) =
  _mkRequest "GET" ["/pool_blocks"]
    `addQuery` toQuery ("_pool_bech32", Just poolBech32)

data PoolBlocksGet  

-- | /Optional Param/ "_epoch_no" - Epoch Number to fetch details for
instance HasOptionalParam PoolBlocksGet EpochNo where
  applyOptionalParam req (EpochNo xs) =
    req `addQuery` toQuery ("_epoch_no", Just xs)
-- | @application/json@
instance Produces PoolBlocksGet MimeJSON
...
poolDelegatorsGet
  :: PoolBech32 -- ^ "poolBech32" -  Pool ID in bech32 format
  -> KoiosRequest PoolDelegatorsGet MimeNoContent [PoolDelegatorsInner] MimeJSON
poolDelegatorsGet (PoolBech32 poolBech32) =
  _mkRequest "GET" ["/pool_delegators"]
    `addQuery` toQuery ("_pool_bech32", Just poolBech32)

data PoolDelegatorsGet  

-- | /Optional Param/ "_epoch_no" - Epoch Number to fetch details for
instance HasOptionalParam PoolDelegatorsGet EpochNo where
  applyOptionalParam req (EpochNo xs) =
    req `addQuery` toQuery ("_epoch_no", Just xs)
-- | @application/json@
instance Produces PoolDelegatorsGet MimeJSON
...
poolHistoryGet
  :: PoolBech32 -- ^ "poolBech32" -  Pool ID in bech32 format
  -> KoiosRequest PoolHistoryGet MimeNoContent [PoolHistoryInfoInner] MimeJSON
poolHistoryGet (PoolBech32 poolBech32) =
  _mkRequest "GET" ["/pool_history"]
    `addQuery` toQuery ("_pool_bech32", Just poolBech32)

data PoolHistoryGet  

-- | /Optional Param/ "_epoch_no" - Epoch Number to fetch details for
instance HasOptionalParam PoolHistoryGet EpochNo where
  applyOptionalParam req (EpochNo xs) =
    req `addQuery` toQuery ("_epoch_no", Just xs)
-- | @application/json@
instance Produces PoolHistoryGet MimeJSON
...
-- 
poolInfoPost
  :: (Consumes PoolInfoPost MimeJSON)
  => KoiosRequest PoolInfoPost MimeJSON [PoolInfoInner] MimeJSON
poolInfoPost =
  _mkRequest "POST" ["/pool_info"]

data PoolInfoPost 
instance HasBodyParam PoolInfoPost PoolInfoPostRequest 

-- | @application/json@
instance Consumes PoolInfoPost MimeJSON

-- | @application/json@
instance Produces PoolInfoPost MimeJSON
...
-- 
poolListGet
  :: KoiosRequest PoolListGet MimeNoContent [PoolListInner] MimeJSON
poolListGet =
  _mkRequest "GET" ["/pool_list"]

data PoolListGet  
-- | @application/json@
instance Produces PoolListGet MimeJSON
...
-- 
poolMetadataPost
  :: (Consumes PoolMetadataPost MimeJSON)
  => KoiosRequest PoolMetadataPost MimeJSON [PoolMetadataInner] MimeJSON
poolMetadataPost =
  _mkRequest "POST" ["/pool_metadata"]

data PoolMetadataPost 
instance HasBodyParam PoolMetadataPost PoolMetadataPostRequest 

-- | @application/json@
instance Consumes PoolMetadataPost MimeJSON

-- | @application/json@
instance Produces PoolMetadataPost MimeJSON
...
-- 
poolRelaysGet
  :: KoiosRequest PoolRelaysGet MimeNoContent [PoolRelaysInner] MimeJSON
poolRelaysGet =
  _mkRequest "GET" ["/pool_relays"]

data PoolRelaysGet  
-- | @application/json@
instance Produces PoolRelaysGet MimeJSON
...
-- 
poolUpdatesGet
  :: KoiosRequest PoolUpdatesGet MimeNoContent [PoolUpdatesInner] MimeJSON
poolUpdatesGet =
  _mkRequest "GET" ["/pool_updates"]

data PoolUpdatesGet  

-- | /Optional Param/ "_pool_bech32" - Pool ID in bech32 format (optional)
instance HasOptionalParam PoolUpdatesGet PoolBech32 where
  applyOptionalParam req (PoolBech32 xs) =
    req `addQuery` toQuery ("_pool_bech32", Just xs)
-- | @application/json@
instance Produces PoolUpdatesGet MimeJSON
