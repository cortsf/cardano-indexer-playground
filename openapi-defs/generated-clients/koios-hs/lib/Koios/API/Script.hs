...
-- 
nativeScriptListGet
  :: KoiosRequest NativeScriptListGet MimeNoContent [NativeScriptListInner] MimeJSON
nativeScriptListGet =
  _mkRequest "GET" ["/native_script_list"]

data NativeScriptListGet  
-- | @application/json@
instance Produces NativeScriptListGet MimeJSON
...
-- 
plutusScriptListGet
  :: KoiosRequest PlutusScriptListGet MimeNoContent [PlutusScriptListInner] MimeJSON
plutusScriptListGet =
  _mkRequest "GET" ["/plutus_script_list"]

data PlutusScriptListGet  
-- | @application/json@
instance Produces PlutusScriptListGet MimeJSON
...
-- 
scriptRedeemersGet
  :: ScriptHash -- ^ "scriptHash" -  Script hash in hexadecimal format (hex)
  -> KoiosRequest ScriptRedeemersGet MimeNoContent [ScriptRedeemersInner] MimeJSON
scriptRedeemersGet (ScriptHash scriptHash) =
  _mkRequest "GET" ["/script_redeemers"]
    `addQuery` toQuery ("_script_hash", Just scriptHash)

data ScriptRedeemersGet  
-- | @application/json@
instance Produces ScriptRedeemersGet MimeJSON
