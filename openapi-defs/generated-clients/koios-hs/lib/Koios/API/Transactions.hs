...
module Koios.API.Transactions where
...
-- 
submittxPost
  :: (Consumes SubmittxPost MimeCbor)
  => KoiosRequest SubmittxPost MimeCbor Text MimeJSON
submittxPost =
  _mkRequest "POST" ["/submittx"]

data SubmittxPost 
instance HasBodyParam SubmittxPost Body 

-- | @application/cbor@
instance Consumes SubmittxPost MimeCbor

-- | @application/json@
instance Produces SubmittxPost MimeJSON
...
-- 
txInfoPost
  :: (Consumes TxInfoPost MimeJSON)
  => KoiosRequest TxInfoPost MimeJSON [TxInfoInner] MimeJSON
txInfoPost =
  _mkRequest "POST" ["/tx_info"]

data TxInfoPost 
instance HasBodyParam TxInfoPost TxInfoPostRequest 

-- | @application/json@
instance Consumes TxInfoPost MimeJSON

-- | @application/json@
instance Produces TxInfoPost MimeJSON
...
-- 
txMetadataPost
  :: (Consumes TxMetadataPost MimeJSON)
  => KoiosRequest TxMetadataPost MimeJSON [TxMetadataInner] MimeJSON
txMetadataPost =
  _mkRequest "POST" ["/tx_metadata"]

data TxMetadataPost 
instance HasBodyParam TxMetadataPost TxInfoPostRequest 

-- | @application/json@
instance Consumes TxMetadataPost MimeJSON

-- | @application/json@
instance Produces TxMetadataPost MimeJSON
...
-- 
txMetalabelsGet
  :: KoiosRequest TxMetalabelsGet MimeNoContent [TxMetalabelsInner] MimeJSON
txMetalabelsGet =
  _mkRequest "GET" ["/tx_metalabels"]

data TxMetalabelsGet  
-- | @application/json@
instance Produces TxMetalabelsGet MimeJSON
...
-- 
txStatusPost
  :: (Consumes TxStatusPost MimeJSON)
  => KoiosRequest TxStatusPost MimeJSON [TxStatusInner] MimeJSON
txStatusPost =
  _mkRequest "POST" ["/tx_status"]

data TxStatusPost 
instance HasBodyParam TxStatusPost TxInfoPostRequest 

-- | @application/json@
instance Consumes TxStatusPost MimeJSON

-- | @application/json@
instance Produces TxStatusPost MimeJSON
...
-- 
txUtxosPost
  :: (Consumes TxUtxosPost MimeJSON)
  => KoiosRequest TxUtxosPost MimeJSON [TxUtxosInner] MimeJSON
txUtxosPost =
  _mkRequest "POST" ["/tx_utxos"]

data TxUtxosPost 
instance HasBodyParam TxUtxosPost TxInfoPostRequest 

-- | @application/json@
instance Consumes TxUtxosPost MimeJSON

-- | @application/json@
instance Produces TxUtxosPost MimeJSON
