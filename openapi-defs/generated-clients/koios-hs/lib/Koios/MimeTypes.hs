...
data MimeCbor = MimeCbor deriving (P.Typeable)

-- | @application/cbor@
instance MimeType MimeCbor where
  mimeType _ = Just $ P.fromString "application/cbor"
-- instance MimeRender MimeCbor T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeCbor T.Text where mimeUnrender _ = undefined
