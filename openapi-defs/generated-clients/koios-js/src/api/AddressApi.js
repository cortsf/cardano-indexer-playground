...
export default class AddressApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addressAssetsPost operation.
     * @callback module:api/AddressApi~addressAssetsPostCallback
     ...
     * @param {module:api/AddressApi~addressAssetsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    addressAssetsPost(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the addressInfoPost operation.
     * @callback module:api/AddressApi~addressInfoPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/AddressApi~addressInfoPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    addressInfoPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['UNKNOWN_BASE_TYPE'];
    ...
    /**
     * Callback function to receive the result of the addressTxsPost operation.
     * @callback module:api/AddressApi~addressTxsPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/AddressApi~addressTxsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    addressTxsPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['UNKNOWN_BASE_TYPE'];
    ...
    /**
     * Callback function to receive the result of the credentialTxsPost operation.
     * @callback module:api/AddressApi~credentialTxsPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/AddressApi~credentialTxsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    credentialTxsPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['UNKNOWN_BASE_TYPE'];
