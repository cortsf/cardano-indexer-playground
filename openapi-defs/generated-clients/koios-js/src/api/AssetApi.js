...
export default class AssetApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the assetAddressListGet operation.
     * @callback module:api/AssetApi~assetAddressListGetCallback
     ...
     * @param {String} opts.assetName Asset Name in hexadecimal format (hex)
     * @param {module:api/AssetApi~assetAddressListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    assetAddressListGet(assetPolicy, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'assetPolicy' is set
      if (assetPolicy === undefined || assetPolicy === null) {
        throw new Error("Missing the required parameter 'assetPolicy' when calling assetAddressListGet");
      }
    ...
    /**
     * Callback function to receive the result of the assetHistoryGet operation.
     * @callback module:api/AssetApi~assetHistoryGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.assetName Asset Name in hexadecimal format (hex)
     * @param {module:api/AssetApi~assetHistoryGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    assetHistoryGet(assetPolicy, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'assetPolicy' is set
      if (assetPolicy === undefined || assetPolicy === null) {
        throw new Error("Missing the required parameter 'assetPolicy' when calling assetHistoryGet");
      }
    ...
    /**
     * Callback function to receive the result of the assetInfoGet operation.
     * @callback module:api/AssetApi~assetInfoGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.assetName Asset Name in hexadecimal format (hex)
     * @param {module:api/AssetApi~assetInfoGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    assetInfoGet(assetPolicy, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'assetPolicy' is set
      if (assetPolicy === undefined || assetPolicy === null) {
        throw new Error("Missing the required parameter 'assetPolicy' when calling assetInfoGet");
      }
    ...
    /**
     * Callback function to receive the result of the assetListGet operation.
     * @callback module:api/AssetApi~assetListGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AssetApi~assetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    assetListGet(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the assetPolicyInfoGet operation.
     * @callback module:api/AssetApi~assetPolicyInfoGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} assetPolicy Asset Policy ID in hexadecimal format (hex)
     * @param {module:api/AssetApi~assetPolicyInfoGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    assetPolicyInfoGet(assetPolicy, callback) {
      let postBody = null;
      // verify the required parameter 'assetPolicy' is set
      if (assetPolicy === undefined || assetPolicy === null) {
        throw new Error("Missing the required parameter 'assetPolicy' when calling assetPolicyInfoGet");
      }
    ...
    /**
     * Callback function to receive the result of the assetSummaryGet operation.
     * @callback module:api/AssetApi~assetSummaryGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.assetName Asset Name in hexadecimal format (hex)
     * @param {module:api/AssetApi~assetSummaryGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    assetSummaryGet(assetPolicy, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'assetPolicy' is set
      if (assetPolicy === undefined || assetPolicy === null) {
        throw new Error("Missing the required parameter 'assetPolicy' when calling assetSummaryGet");
      }
    ...
    /**
     * Callback function to receive the result of the assetTxsGet operation.
     * @callback module:api/AssetApi~assetTxsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.assetName Asset Name in hexadecimal format (hex)
     * @param {module:api/AssetApi~assetTxsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    assetTxsGet(assetPolicy, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'assetPolicy' is set
      if (assetPolicy === undefined || assetPolicy === null) {
        throw new Error("Missing the required parameter 'assetPolicy' when calling assetTxsGet");
      }
