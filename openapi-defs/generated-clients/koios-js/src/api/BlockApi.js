...
import OpCertCounter from '../model/OpCertCounter';
import Pool from '../model/Pool';
import ProtocolMajor from '../model/ProtocolMajor';
import ProtocolMinor from '../model/ProtocolMinor';
import TxCount from '../model/TxCount';
import TxHash from '../model/TxHash';
import UNKNOWN_BASE_TYPE from '../model/UNKNOWN_BASE_TYPE';
import VrfKey from '../model/VrfKey';
...
export default class BlockApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the blockInfoPost operation.
     * @callback module:api/BlockApi~blockInfoPostCallback
     ...
     * @param {module:api/BlockApi~blockInfoPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    blockInfoPost(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the blockTxsPost operation.
     * @callback module:api/BlockApi~blockTxsPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/BlockApi~blockTxsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    blockTxsPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['UNKNOWN_BASE_TYPE'];
     ...
     * @callback module:api/BlockApi~blocksGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/BlockApi~blocksGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    blocksGet(callback) {
      let postBody = null;
