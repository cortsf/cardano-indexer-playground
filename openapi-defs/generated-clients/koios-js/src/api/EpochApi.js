...
* @version 1.0.6
*/
export default class EpochApi {

    /**
    * Constructs a new EpochApi. 
    * @alias module:api/EpochApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the epochInfoGet operation.
     * @callback module:api/EpochApi~epochInfoGetCallback
     ...
     * @param {module:api/EpochApi~epochInfoGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    epochInfoGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the epochParamsGet operation.
     * @callback module:api/EpochApi~epochParamsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.epochNo Epoch Number to fetch details for
     * @param {module:api/EpochApi~epochParamsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    epochParamsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
