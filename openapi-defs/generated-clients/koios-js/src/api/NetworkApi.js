...
export default class NetworkApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the genesisGet operation.
     * @callback module:api/NetworkApi~genesisGetCallback
     ...
     * @param {module:api/NetworkApi~genesisGetCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    /**
     * Callback function to receive the result of the tipGet operation.
     * @callback module:api/NetworkApi~tipGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/NetworkApi~tipGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    tipGet(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the totalsGet operation.
     * @callback module:api/NetworkApi~totalsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/NetworkApi~totalsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    totalsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
