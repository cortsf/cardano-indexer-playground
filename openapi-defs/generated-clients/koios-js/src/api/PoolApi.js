...
import AbsSlot from '../model/AbsSlot';
import ActiveEpochNo from '../model/ActiveEpochNo';
import BlockHeight from '../model/BlockHeight';
import BlockTime from '../model/BlockTime';
import EpochNo from '../model/EpochNo';
import EpochSlot from '../model/EpochSlot';
import FixedCost from '../model/FixedCost';
import Hash from '../model/Hash';
import Margin from '../model/Margin';
import MetaHash from '../model/MetaHash';
import MetaJson from '../model/MetaJson';
import MetaUrl from '../model/MetaUrl';
import Owners from '../model/Owners';
import Pledge from '../model/Pledge';
import PoolIdBech32 from '../model/PoolIdBech32';
import PoolIdHex from '../model/PoolIdHex';
import PoolStatus from '../model/PoolStatus';
import Relays from '../model/Relays';
import RetiringEpoch from '../model/RetiringEpoch';
import RewardAddr from '../model/RewardAddr';
import StakeAddress from '../model/StakeAddress';
import TxHash from '../model/TxHash';
import UNKNOWN_BASE_TYPE from '../model/UNKNOWN_BASE_TYPE';
import VrfKeyHash from '../model/VrfKeyHash';
...
export default class PoolApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the poolBlocksGet operation.
     * @callback module:api/PoolApi~poolBlocksGetCallback
     ...
     * @param {String} opts.epochNo Epoch Number to fetch details for
     * @param {module:api/PoolApi~poolBlocksGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    poolBlocksGet(poolBech32, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'poolBech32' is set
      if (poolBech32 === undefined || poolBech32 === null) {
        throw new Error("Missing the required parameter 'poolBech32' when calling poolBlocksGet");
      }
    ...
    /**
     * Callback function to receive the result of the poolDelegatorsGet operation.
     * @callback module:api/PoolApi~poolDelegatorsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.epochNo Epoch Number to fetch details for
     * @param {module:api/PoolApi~poolDelegatorsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    poolDelegatorsGet(poolBech32, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'poolBech32' is set
      if (poolBech32 === undefined || poolBech32 === null) {
        throw new Error("Missing the required parameter 'poolBech32' when calling poolDelegatorsGet");
      }
    ...
    /**
     * Callback function to receive the result of the poolHistoryGet operation.
     * @callback module:api/PoolApi~poolHistoryGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.epochNo Epoch Number to fetch details for
     * @param {module:api/PoolApi~poolHistoryGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    poolHistoryGet(poolBech32, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'poolBech32' is set
      if (poolBech32 === undefined || poolBech32 === null) {
        throw new Error("Missing the required parameter 'poolBech32' when calling poolHistoryGet");
      }
    ...
    /**
     * Callback function to receive the result of the poolInfoPost operation.
     * @callback module:api/PoolApi~poolInfoPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/PoolApi~poolInfoPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    poolInfoPost(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the poolListGet operation.
     * @callback module:api/PoolApi~poolListGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PoolApi~poolListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    poolListGet(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the poolMetadataPost operation.
     * @callback module:api/PoolApi~poolMetadataPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/PoolApi~poolMetadataPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    poolMetadataPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['UNKNOWN_BASE_TYPE'];
    ...
    /**
     * Callback function to receive the result of the poolRelaysGet operation.
     * @callback module:api/PoolApi~poolRelaysGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PoolApi~poolRelaysGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    poolRelaysGet(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the poolUpdatesGet operation.
     * @callback module:api/PoolApi~poolUpdatesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.poolBech32 Pool ID in bech32 format (optional)
     * @param {module:api/PoolApi~poolUpdatesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    poolUpdatesGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
