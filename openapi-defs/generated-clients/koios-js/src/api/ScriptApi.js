...
export default class ScriptApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the nativeScriptListGet operation.
     * @callback module:api/ScriptApi~nativeScriptListGetCallback
     ...
     * @param {module:api/ScriptApi~nativeScriptListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    nativeScriptListGet(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the plutusScriptListGet operation.
     * @callback module:api/ScriptApi~plutusScriptListGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ScriptApi~plutusScriptListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    plutusScriptListGet(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the scriptRedeemersGet operation.
     * @callback module:api/ScriptApi~scriptRedeemersGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ScriptApi~scriptRedeemersGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    scriptRedeemersGet(scriptHash, callback) {
      let postBody = null;
      // verify the required parameter 'scriptHash' is set
      if (scriptHash === undefined || scriptHash === null) {
        throw new Error("Missing the required parameter 'scriptHash' when calling scriptRedeemersGet");
      }
