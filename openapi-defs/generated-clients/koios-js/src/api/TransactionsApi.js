...
export default class TransactionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the submittxPost operation.
     * @callback module:api/TransactionsApi~submittxPostCallback
     ...
     * @param {module:api/TransactionsApi~submittxPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    submittxPost(opts, callback) {
      opts = opts || {};
      ...
      let authNames = [];
      let contentTypes = ['application/cbor'];
    ...
    /**
     * Callback function to receive the result of the txInfoPost operation.
     * @callback module:api/TransactionsApi~txInfoPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TransactionsApi~txInfoPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    txInfoPost(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the txMetadataPost operation.
     * @callback module:api/TransactionsApi~txMetadataPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/TransactionsApi~txMetadataPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    txMetadataPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['UNKNOWN_BASE_TYPE'];
    ...
    /**
     * Callback function to receive the result of the txMetalabelsGet operation.
     * @callback module:api/TransactionsApi~txMetalabelsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TransactionsApi~txMetalabelsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    txMetalabelsGet(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the txStatusPost operation.
     * @callback module:api/TransactionsApi~txStatusPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/TransactionsApi~txStatusPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    txStatusPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['UNKNOWN_BASE_TYPE'];
    ...
    /**
     * Callback function to receive the result of the txUtxosPost operation.
     * @callback module:api/TransactionsApi~txUtxosPostCallback
     * @param {String} error Error message, if any.
     * @param {Array.<Object>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object.<String, module:model/UNKNOWN_BASE_TYPE>} opts.UNKNOWN_BASE_TYPE 
     * @param {module:api/TransactionsApi~txUtxosPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    txUtxosPost(opts, callback) {
      opts = opts || {};
      let postBody = opts['UNKNOWN_BASE_TYPE'];
