...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoiosApi.AccountApi();
  });
  ...
  describe('AccountApi', function() {
    describe('accountAddressesPost', function() {
      it('should call accountAddressesPost successfully', function(done) {
        //uncomment below and update the code to test accountAddressesPost
        //instance.accountAddressesPost(function(error) {
    ...
    describe('accountAssetsPost', function() {
      it('should call accountAssetsPost successfully', function(done) {
        //uncomment below and update the code to test accountAssetsPost
        //instance.accountAssetsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('accountHistoryPost', function() {
      it('should call accountHistoryPost successfully', function(done) {
        //uncomment below and update the code to test accountHistoryPost
        //instance.accountHistoryPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('accountInfoPost', function() {
      it('should call accountInfoPost successfully', function(done) {
        //uncomment below and update the code to test accountInfoPost
        //instance.accountInfoPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('accountRewardsPost', function() {
      it('should call accountRewardsPost successfully', function(done) {
        //uncomment below and update the code to test accountRewardsPost
        //instance.accountRewardsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('accountUpdatesPost', function() {
      it('should call accountUpdatesPost successfully', function(done) {
        //uncomment below and update the code to test accountUpdatesPost
        //instance.accountUpdatesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
