...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoiosApi.AssetApi();
  });
  ...
  describe('AssetApi', function() {
    describe('assetAddressListGet', function() {
      it('should call assetAddressListGet successfully', function(done) {
        //uncomment below and update the code to test assetAddressListGet
        //instance.assetAddressListGet(function(error) {
    ...
    describe('assetHistoryGet', function() {
      it('should call assetHistoryGet successfully', function(done) {
        //uncomment below and update the code to test assetHistoryGet
        //instance.assetHistoryGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('assetInfoGet', function() {
      it('should call assetInfoGet successfully', function(done) {
        //uncomment below and update the code to test assetInfoGet
        //instance.assetInfoGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('assetListGet', function() {
      it('should call assetListGet successfully', function(done) {
        //uncomment below and update the code to test assetListGet
        //instance.assetListGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('assetPolicyInfoGet', function() {
      it('should call assetPolicyInfoGet successfully', function(done) {
        //uncomment below and update the code to test assetPolicyInfoGet
        //instance.assetPolicyInfoGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('assetSummaryGet', function() {
      it('should call assetSummaryGet successfully', function(done) {
        //uncomment below and update the code to test assetSummaryGet
        //instance.assetSummaryGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('assetTxsGet', function() {
      it('should call assetTxsGet successfully', function(done) {
        //uncomment below and update the code to test assetTxsGet
        //instance.assetTxsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
