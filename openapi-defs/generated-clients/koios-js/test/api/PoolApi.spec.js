...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.KoiosApi);
  }
}(this, function(expect, KoiosApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new KoiosApi.PoolApi();
  });
  ...
  describe('PoolApi', function() {
    describe('poolBlocksGet', function() {
      it('should call poolBlocksGet successfully', function(done) {
        //uncomment below and update the code to test poolBlocksGet
        //instance.poolBlocksGet(function(error) {
    ...
    describe('poolDelegatorsGet', function() {
      it('should call poolDelegatorsGet successfully', function(done) {
        //uncomment below and update the code to test poolDelegatorsGet
        //instance.poolDelegatorsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('poolHistoryGet', function() {
      it('should call poolHistoryGet successfully', function(done) {
        //uncomment below and update the code to test poolHistoryGet
        //instance.poolHistoryGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('poolInfoPost', function() {
      it('should call poolInfoPost successfully', function(done) {
        //uncomment below and update the code to test poolInfoPost
        //instance.poolInfoPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('poolListGet', function() {
      it('should call poolListGet successfully', function(done) {
        //uncomment below and update the code to test poolListGet
        //instance.poolListGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('poolMetadataPost', function() {
      it('should call poolMetadataPost successfully', function(done) {
        //uncomment below and update the code to test poolMetadataPost
        //instance.poolMetadataPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('poolRelaysGet', function() {
      it('should call poolRelaysGet successfully', function(done) {
        //uncomment below and update the code to test poolRelaysGet
        //instance.poolRelaysGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('poolUpdatesGet', function() {
      it('should call poolUpdatesGet successfully', function(done) {
        //uncomment below and update the code to test poolUpdatesGet
        //instance.poolUpdatesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
