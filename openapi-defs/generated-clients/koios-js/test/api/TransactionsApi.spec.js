...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoiosApi.TransactionsApi();
  });
  ...
  describe('TransactionsApi', function() {
    describe('submittxPost', function() {
      it('should call submittxPost successfully', function(done) {
        //uncomment below and update the code to test submittxPost
        //instance.submittxPost(function(error) {
    ...
    describe('txInfoPost', function() {
      it('should call txInfoPost successfully', function(done) {
        //uncomment below and update the code to test txInfoPost
        //instance.txInfoPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('txMetadataPost', function() {
      it('should call txMetadataPost successfully', function(done) {
        //uncomment below and update the code to test txMetadataPost
        //instance.txMetadataPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('txMetalabelsGet', function() {
      it('should call txMetalabelsGet successfully', function(done) {
        //uncomment below and update the code to test txMetalabelsGet
        //instance.txMetalabelsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('txStatusPost', function() {
      it('should call txStatusPost successfully', function(done) {
        //uncomment below and update the code to test txStatusPost
        //instance.txStatusPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('txUtxosPost', function() {
      it('should call txUtxosPost successfully', function(done) {
        //uncomment below and update the code to test txUtxosPost
        //instance.txUtxosPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
